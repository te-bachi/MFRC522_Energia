...
void Write_MFRC522(uchar addr, uchar val)
{
	...
	//address format：0XXXXXX0
        /*
        Serial.print("Write_MFRC522: address = 0x");
        Serial.print(addr, HEX);
        Serial.print(" / 0x");
        Serial.print((addr<<1)&0x7E, HEX);
        Serial.print(", w-value = 0x");
        Serial.print(val, HEX);
        */
	SPI.transfer((addr<<1)&0x7E);	
	val = SPI.transfer(val);
        /* 
        Serial.print(", r-value = 0x");
...
uchar Read_MFRC522(uchar addr)
{
	...
	val =SPI.transfer(0x00);
        /*
        Serial.print("Read_MFRC522: address = 0x");
        Serial.print(addr, HEX);
        Serial.print(" / 0x");
        Serial.print(((addr<<1)&0x7E) | 0x80, HEX);
